...
(function($) {
    ...
    $.fn.slidingGallery = function(options) {
        ...
        $('#slider').on('swiperight', $.galleryUtility.slideRight);
        $('#slider').on('swipeleft', $.galleryUtility.slideLeft);
    ...
    $.galleryUtility.zoomIn = function() {       
        ...
        timeoutID = setTimeout(playgame, 1000);
    };

    function playgame(){
    	//vamos al home a jugar el juego
        $.mobile.changePage('#home');      
        gameIndex = $.galleryUtility.centerImage.image.attr('id');
